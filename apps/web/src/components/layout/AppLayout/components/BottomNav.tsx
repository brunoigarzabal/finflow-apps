...
export const BottomNav = () => {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-50 flex h-[calc(3.5rem+env(safe-area-inset-bottom))] items-start justify-around border-t bg-background/60 pt-1.5 pb-[env(safe-area-inset-bottom)] backdrop-blur-xl sm:hidden">
